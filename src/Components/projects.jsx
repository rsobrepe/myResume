...
/*
* Projects component to visualize the project's I've worked on using a carousel 
*/
class Projects extends Component {
  ...
  //Function that handles when the carousel has been pressed and which slide it traverses to
  ...
  render() {
    ...
    //Variables indicating which slide to refer to and whether the carousel slides left or right
